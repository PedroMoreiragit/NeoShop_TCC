...
@section('content')
    ...
    <div class="bg-dark_blue_gray p-8 rounded-lg mb-4">
        ...
        <div class="text-white text-center mb-10">
            <h1 class="text-2xl font-bold mb-2">Redefinir a senha</h1>
            <span class="text-gray-500">Redefina sua senha abaixo nos campos</span>
        </div>
        ...
        <form action="" method="post">
            ...
            <div class="text-center mb-6">
                <button class="text-white font-semibold text-xl bg-base rounded-lg py-2 w-full hover:bg-dark">Redefinir</button>
            </div>
        </form>
        {{-- Recognize --}}
        <div>
