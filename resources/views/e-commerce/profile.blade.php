...
@section('content')
  ...
  <div class="bg-blue_gray text-white w-full max-w-2xl rounded-2xl shadow-xl p-6 space-y-8">
    ...
    <div class="flex flex-col items-center gap-3">
      <div class="w-24 h-24 bg-base_color rounded-full flex items-center justify-center text-3xl font-bold shadow-lg">
        P
      </div>
      <h2 class="text-2xl font-bold">Pedro Moreira</h2>
      <p class="text-light text-sm">pedro@email.com</p>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <a href="recuperacao_de_senha" class="bg-base_color hover:bg-dark transition text-white font-semibold py-3 rounded-xl w-full flex items-center justify-center gap-2">
        <i class="ri-lock-password-line text-lg"></i>
        Alterar Senha
      </a>
      <a href="metodos_de_pagameto" class="bg-base_color hover:bg-dark transition text-white font-semibold py-3 rounded-xl w-full flex items-center justify-center gap-2">
        <i class="ri-bank-card-line text-lg"></i>
        Métodos
      </a>
      <a class="bg-red-500 hover:bg-red-600 transition text-white font-semibold py-3 rounded-xl w-full col-span-full flex items-center justify-center gap-2">
